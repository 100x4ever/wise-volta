...
document.addEventListener('DOMContentLoaded', () => {
    ...
    new_antioch: [
      {
        ...
        fullStats: "MOVE: 6\" | RANGED: +1 | MELEE: +1 | ARMOUR: 1 | WOUNDS: 2 | COURAGE: 8+",
        baseKeywords: ["COMMANDER", "INHERENT LEADERSHIP"],
        equip: ["Service Pistol", "Trench Sword", "Body Armour"]
      },
      {
        ...
        baseKeywords: ["DEADEYE AIM", "DIVINE GUIDANCE", "SNIPER"],
        equip: ["Bolt-Action Sniper Rifle"]
      },
      {
        id: "UNIT_NA_STOSSTRUPPEN_VETERAN",
        name: "Stosstruppen Veteran",
        cat: "Elite",
        cost: 55,
        max: 4,
        isLeader: false,
        ...
        baseKeywords: ["TRENCH RAID", "SHOCK TROOPER"],
        equip: ["Submachine Gun", "Trench Knife", "Body Armour"]
      },
      {
        ...
        baseKeywords: ["LINE INFANTRY", "GRIM DISCIPLINE"],
        equip: ["Bolt-Action Rifle", "Trench Knife"]
      },
      {
        ...
        fullStats: "MOVE: 6\" | RANGED: +1 | MELEE: +0 | ARMOUR: 0 | WOUNDS: 1 | COURAGE: 7+",
        baseKeywords: ["FIELD SURGEON", "TREAT WOUNDS", "MEDIC"],
    ...
    trench_pilgrims: [
      {
        ...
        baseKeywords: ["COMMANDER", "HOLY FERVOUR", "ZEALOT"],
        equip: ["Trench Shotgun", "Trench Club"]
      },
      {
        ...
        baseKeywords: ["HEAVY CONSTRUCT", "BLOOD SACRIFICE", "MONSTROUS STRENGTH"],
        equip: ["Two-Handed Greatsword", "Plate Armour"]
      },
      {
        ...
        baseKeywords: ["FANATIC", "MARTYRDOM"],
        equip: ["Trench Club", "Pistol"]
      },
      {
        ...
        baseKeywords: ["SUICIDE BLAST", "UNFLINCHING", "PENITENT"],
        equip: ["Explosive Relic Cross"]
      }
    ],
    iron_sultanate: [
      {
        ...
        cat: "Leader / Specialist",
        cost: 75,
        max: 1,
        isLeader: true,
        img: "images/jabirean_alchemist.jpg",
        fullStats: "MOVE: 6\" | RANGED: +2 | MELEE: +0 | ARMOUR: 1 | WOUNDS: 2 | COURAGE: 8+",
        baseKeywords: ["COMMANDER", "ALCHEMY MASTER", "FIRE IMMUNE"],
        equip: ["Alchemical Flamethrower"]
      },
      {
        id: "UNIT_IS_LION_OF_JABIR",
        name: "Lion of Jabir Automaton",
        cat: "Construct Beast",
        cost: 95,
        max: 2,
        isLeader: false,
        img: "images/lion_of_jabir.jpg",
        fullStats: "MOVE: 7\" | RANGED: +0 | MELEE: +3 | ARMOUR: 2 | WOUNDS: 2 | COURAGE: 10+",
        baseKeywords: ["CLOCKWORK CONSTRUCT", "RAZOR CLAWS", "TERROR"],
        equip: ["Razor Claws & Flame"]
      },
      {
        ...
        fullStats: "MOVE: 6\" | RANGED: +2 | MELEE: +1 | ARMOUR: 2 | WOUNDS: 1 | COURAGE: 8+",
        baseKeywords: ["IRON DISCIPLINE", "MARKSMAN", "ARMOUR-CLAD"],
        equip: ["Jezail Rifle", "Plate Armour"]
      }
    ],
    heretic_legions: [
      {
        ...
        fullStats: "MOVE: 6\" | RANGED: +1 | MELEE: +2 | ARMOUR: 1 | WOUNDS: 2 | COURAGE: 8+",
        baseKeywords: ["COMMANDER", "DARK BLESSINGS", "SACRIFICIAL RITE"],
        equip: ["Unholy Staff", "Hellfire Pistol"]
      },
      {
        id: "UNIT_HL_DEATH_COMMANDO",
        name: "Heretic Death Commando",
        cat: "Elite Infiltrator",
        cost: 65,
        max: 2,
        isLeader: false,
        img: "images/death_commando.jpg",
        fullStats: "MOVE: 7\" | RANGED: +2 | MELEE: +2 | ARMOUR: 1 | WOUNDS: 1 | COURAGE: 8+",
        baseKeywords: ["INFILTRATOR", "STEALTH", "POISON BLADES"],
        equip: ["Submachine Gun", "Trench Knife"]
      },
      {
        id: "UNIT_HL_LORD_OF_TUMOURS",
        ...
        fullStats: "MOVE: 5\" | RANGED: +0 | MELEE: +3 | ARMOUR: 2 | WOUNDS: 4 | COURAGE: 9+",
        baseKeywords: ["BLACK GRAIL PLAGUE", "REGENERATION", "DISEASE AURA", "HEAVY"],
        equip: ["Greatsword", "Rotting Carapace"]
      }
    ],
    serpent_court: [
      {
        id: "UNIT_CS_SERPENT_SORCERER",
        ...
        fullStats: "MOVE: 6\" | RANGED: +1 | MELEE: +1 | ARMOUR: 1 | WOUNDS: 2 | COURAGE: 8+",
        baseKeywords: ["COMMANDER", "GOETIC SORCERY", "VENOMOUS"],
        equip: ["Ritual Dagger"]
      },
      {
        ...
        fullStats: "MOVE: 8\" (FLY) | RANGED: +0 | MELEE: +2 | ARMOUR: 2 | WOUNDS: 2 | COURAGE: 8+",
        baseKeywords: ["FLIGHT", "RENDING LIMBS", "POISON STINGER", "HEAVY"],
        equip: ["Rending Limbs", "Poison Stinger"]
      }
    ],
    mercenaries: [
      {
        id: "UNIT_MC_MERCY_DOG",
        name: "Mercy Dog Medic",
        cat: "Support Beast",
        cost: 25,
        max: 2,
        isLeader: false,
        img: "images/mercy_dog.jpg",
        fullStats: "MOVE: 7\" | RANGED: +0 | MELEE: +1 | ARMOUR: 0 | WOUNDS: 1 | COURAGE: 6+",
        baseKeywords: ["BEAST", "FIRST AID", "TRENCH MEDIC"],
        equip: ["Medical Pouch"]
      }
    ]
  };
  ...
  selFaction.addEventListener('change', renderCatalog);
  selBudget.addEventListener('change', updateRosterAudit);
