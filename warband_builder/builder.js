...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const masterSubfactions = {
    ...
    court_serpent: [
      { id: "cs_ambassador", name: "Ambassadors of the Serpent", rule: "Subtle Assassination: Assassins gain +2 to hit against enemy Leaders." },
      { id: "cs_locust", name: "Pit Locust Swarm", rule: "Flying Toxins: Flying monstrosities ignore terrain restrictions." },
      { id: "cs_brazen", name: "Brazen Bull Cult", rule: "Monstrous Siege Engine: Brazen Bull deals +2 Melee Injury modifier." }
    ]
  };
