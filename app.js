...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const fullFactionCatalog = {
    ...
    "trench_pilgrims": [
      ...
      { name: "Saint Lazarus Resurrected", cost: 110, gloryCost: 2, cat: "Leader", baseMM: 32, move: 6, ranged: 0, melee: 4, armour: 2, wounds: 3, img: "game_engine/images/martyr_penitent.jpg", kw: ["DIVINE GUIDANCE", "REGENERATION"], defaultSlots: { melee: "Greatsword / Eviscerator" } },
      { name: "Stigmatic Nun", cost: 60, gloryCost: 0, cat: "Elite", baseMM: 25, move: 6, ranged: -1, melee: 2, armour: 1, wounds: 1, img: "game_engine/images/martyr_penitent.jpg", kw: ["STIGMATA BLEED", "HOLY FLAIL"], defaultSlots: { melee: "Holy Iron Flail" } },
      { name: "Inquisitorial Witchburner", cost: 55, gloryCost: 0, cat: "Specialist", baseMM: 25, move: 6, ranged: 1, melee: 1, armour: 1, wounds: 1, img: "game_engine/images/trench_chaplain.jpg", kw: ["PURIFYING FIRE", "WITCH HUNTER"], defaultSlots: { ranged: "Alchemical Flamethrower", melee: "Executioner Axe" } },
    ...
    "serpent_court": [
      ...
      { name: "Sorcerer of the Serpent", cost: 75, gloryCost: 0, cat: "Specialist", baseMM: 32, move: 6, ranged: 2, melee: 1, armour: 1, wounds: 2, img: "game_engine/images/serpent_sorcerer.jpg", kw: ["COMMANDER", "GOETIC SORCERY", "SERPENT MAGIC"], defaultSlots: { ranged: "Hellfire Pistol", melee: "Trench Knife / Dagger" } },
      ...
      { name: "Brazen Bull Siege Engine", cost: 120, gloryCost: 0, cat: "Monster", baseMM: 50, move: 5, ranged: 1, melee: 4, armour: 3, wounds: 4, img: "game_engine/images/brazen_bull.jpg", kw: ["HEAVY CONSTRUCT", "MONSTROUS STRENGTH"], defaultSlots: {} },
